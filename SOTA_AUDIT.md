...
- **Banca Finint = #1 Italian minibond arranger 2025** — 53 issuances, €294.5M
- Typical structure: **6-year amortizing**, size €5-25M per tranche
- Recent pricing: Codess 3.85% annual coupon

Reference: [Osservatorio Minibond Polimi — Banca Finint primo arranger](https://financecommunity.it/osservatorio-minibond-polimi-banca-finint-primo-arranger-in-italia/), [Investire Magazine — Banca Finint leader 2025](https://www.investiremag.it/investire/2026/03/23/news/minibond-banca-finint-si-conferma-leader-italia/), [BeBeez — ICM €25M minibond 6y amortizing](https://bebeez.it/private-debt/il-costruttore-di-grandi-opere-icm-emette-minibond-da-25-mln-con-la-regia-di-banca-finint/).
