...
Closes the ChatGPT round-2 IC review's Killer #1: "the Trust Layer needs
...
# Catastrophic-deviation explanations — required by ChatGPT acceptance criterion.
...
def render_markdown(results: list[Result]) -> str:
    ...
    lines.append("")
    lines.append(
        "**The acceptance bar (per ChatGPT round-2)**: zero catastrophic misses *with no "
    ...
    lines.append("")
    lines.append(
        "3. **For the original ChatGPT Killer #1 (Enel +743% with no Trust "
