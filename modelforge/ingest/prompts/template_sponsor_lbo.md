# Sponsor LBO template — extractor guidance

Target spec class: `modelforge.spec.sponsor_lbo.SponsorLBOSpec`.

Extends unitranche with sponsor-side fields:
purchase-price build, PPA intangibles, sponsor capital structure,
exit scenarios (strategic / IPO / secondary), hurdle analysis, GP
promote waterfall, NWC closing peg, earnout, dividend recap.

Core unitranche extraction rules below apply verbatim; emit sponsor-
specific fields when they appear in the data room (CIM, IC memo,
