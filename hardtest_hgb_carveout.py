...
SCOPE: this template is a 3-statement model + an HGB-Recon (GewSt) overlay. It
does NOT render a standalone-EBITDA *bridge* (reported -> allocated corp costs ->
dis-synergies/stranded -> TSA -> standalone adjusted EBITDA), nor a carve-out EV
(EBITDA x multiple) or DCF on standalone cashflows, nor any TSA time-boundary.
Those prescribed economic checks therefore have nothing in the deliverable to
reconcile; they are reported as GAPS, not passes. We validate everything that IS
rendered.
"""
