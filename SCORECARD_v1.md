# ModelForge SOTA Scorecard v1 — Original (Apr 17, 2026)

> **⚠️ SUPERSEDED** — This was the first founder-self-graded scorecard. Canonical doc: **[SCORECARD.md](SCORECARD.md)** (consensus 5.45, dated 2026-05-15). Preserved here for historical transparency. Originally located at `SCORECARD.md` until 2026-05-15 when the canonical filename was promoted to the consensus document.
